...
public class RouterProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        try {
            ...
            if (type != null) {
                JavaFile.builder("cn.campusapp.router.router.router", type)
    ...
    private TypeSpec getRouterTableInitializer(Set<? extends Element> elements) throws ClassNotFoundException, TargetErrorException {
        ...
        ClassName namedBoards = ClassName.get("cn.campusapp.router.router", "ActivityRouter");

        ClassName name = ClassName.get("cn.campusapp.router.router.router", className);

        MethodSpec.Builder aopBuild = MethodSpec.methodBuilder("initRouter")
                .addModifiers(Modifier.PUBLIC)
                .addAnnotation(AnnotationSpec.builder(Around.class)
                        .addMember("value", "\"execution(* cn.campusapp.router.router.ActivityRouter.init(android.content.Context))\"")
                        .build())
